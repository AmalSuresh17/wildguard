...
def cam(id):
    ...
    while(True):
        ...
        if frame_count == (2 * frame_rate):
            ...
            cv2.imwrite("C:\\Users\\amals\\OneDrive\\Documents\\wild_django\\wild_django\\wild_animal\\static\\pic2.png",image_np)

            # image_data = tf.gfile.FastGFile("C:\\Users\\IDZ\\OneDrive\\Desktop\\Early Warning\\Warning_System\\pic.jpg",
            image_data = tf.gfile.FastGFile("C:\\Users\\amals\\OneDrive\\Documents\\wild_django\\wild_django\\wild_animal\\static\\pic2.png",
                                            'rb').read()
